  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed top-4 left-4 z-50 w-10 h-10 rounded-xl bg-navy-800 text-white flex items-center justify-center shadow-soft-md"
        ...
        {mobileOpen && (
          ...
          >
            ...
            <motion.div 
              ...
              className="absolute left-0 top-0 h-full w-72 bg-navy-800 shadow-soft-xl"
            >
              <button
                onClick={() => setMobileOpen(false)}
